...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todoEvents = __webpack_require__(8);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://ryaong792todo.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var todoui = __webpack_require__(10);
	var todoapi = __webpack_require__(32);
	...
	var createTask = function createTask() {
	  ...
	  todoapi.createTask($(this).closest('a').data('id'), prompt('Enter the task name', '')).then(todoui.createTaskSuccess).catch(todoui.createTaskFailure).done(getList);
	};

	// **** Get TASK ****
	var getTask = function getTask() {
	  event.preventDefault();
	  todoapi.getTask().then(todoui.getTaskSuccess).catch(todoui.getTaskFailure);
	};

	// **** UPDATE TASK ****
	var updateTask = function updateTask() {
	  event.preventDefault();
	  todoapi.updateTask($(this).closest('li').prev().data('id'), $(this).closest('li').data('id'), prompt('Enter the new name', $(this).closest('li').data('name'))).then(todoui.updateTaskSuccess).catch(todoui.updateTaskFailure).done(getList);
	};

	// **** DISTORY TASK ****
	var deleteTask = function deleteTask() {
	  event.preventDefault();
	  todoapi.deleteTask($(this).data('id'), $(this).closest('li').data('id')).then(todoui.deleteTaskSuccess).catch(todoui.deleteTaskFailure);
	};
	...
	var createList = function createList() {
	  ...
	  todoapi.createList(data).then(todoui.createListSuccess).catch(todoui.createListFailure).done(getList);
	};

	// **** GET LIST ****
	var getList = function getList() {
	  // event.preventDefault()
	  todoapi.getList().then(todoui.getListSuccess).catch(todoui.getListFailure);
	  $('.todolist').show();
	};
	...
	var updateList = function updateList() {
	  event.preventDefault();
	  todoapi.updateList($(this).closest('a').data('id'), prompt('Enter the new name', $(this).closest('a').data('name'))).then(todoui.updateListSuccess).catch(todoui.updateListFailure).done(getList);
	};

	// **** DISTORY LIST ****
	var deleteList = function deleteList() {
	  event.preventDefault();
	  todoapi.deleteList($(this).closest('a').data('id')).then(todoui.deleteListSuccess).catch(todoui.deleteListFailure);
	};
	...
	// ************** OTHER JS FUCNTIONS ******************
	var TableDropDown = function TableDropDown() {
	  var $this = $(this);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('.dialog2').hide();
	  $('.dialog3').hide();
	  $('.listing').on('click', getList).on('click', getTask);
	  $('.create').on('submit', createList);
	  $('.list').on('click', '.delete', deleteList).on('click', '.toggle', TableDropDown).on('click', '.update', updateList).on('click', '.add_task', createTask).on('click', '.delete_task', deleteTask).on('click', '.update_task', updateTask);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displayList = __webpack_require__(12);
	var animationEnd = 'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend';

	// **************** SUCCESS / FAILURE FOR TASK *********************
	// **** CREATE TASK SUCCESS / FAILURE ****
	// **** SUCCESS CREATED TASK ****
	var createTaskSuccess = function createTaskSuccess(data) {
	  store.tasks = data.tasks;
	};
	var createTaskFailure = function createTaskFailure(data) {};

	// **** READ TASK SUCCESS / FAILURE  ****
	// **** SUCCESS READ TASK****
	var getTaskSuccess = function getTaskSuccess(data) {};
	// **** FAILURE READ TASK ****
	var getTaskFailure = function getTaskFailure() {};
	// **** UPDATE TASK SUCCESS / FAILURE  ****
	// **** SUCCESS UPDATE TASK****
	var updateTaskSuccess = function updateTaskSuccess(data) {
	  var item = $('.list').find('li[data-id=' + data.id + ']');
	  item.find('p').html(data.name);
	};
	// **** FAILURE UPDATE LIST ****
	var updateTaskFailure = function updateTaskFailure(data) {
	...
	var deleteTaskSuccess = function deleteTaskSuccess(data) {
	  ...
	  $(undefined).closest('li').hide();
	};
	// **** FAILURE DELETE TASK ****
	var deleteTaskFailure = function deleteTaskFailure(data) {
	...
	var createListFailure = function createListFailure(error) {
	  $('#create_list')[0].reset;
	  return error;
	};
	...
	var getListSuccess = function getListSuccess(data) {
	  var displayListHtml = displayList({
	    list: data.lists
	  });
	...
	var updateListSuccess = function updateListSuccess(data) {
	  data = data.list;
	  var item = $('.list').find('a[data-id=' + data.id + ']');
	  item.find('p').html(data.name);
	};
	// **** FAILURE UPDATE LIST ****
	var updateListFailure = function updateListFailure(data) {};
	// **** DELETE LIST SUCCESS / FAILURE  ****
	// **** SUCCESS DELETE LIST****
	var deleteListSuccess = function deleteListSuccess(data) {
	  $('.list').find('a[data-id=' + data.id + ']').addClass('animation hinge').one(animationEnd, function () {
	    $(this).closest('a').hide();
	  });
	};
	// **** FAILURE DELETE LIST ****
	var deleteListFailure = function deleteListFailure(data) {
	...
	module.exports = {
	  ...
	  deleteListFailure: deleteListFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <li data-id=\""
	    ...
	    + "</h2>\n  <div>\n    <p>list: "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + " </p>\n    <p><button class=\"delete\" name=\"button\">delete</button></p>\n    <p><button class=\"update\" name=\"button\">update</button></p>\n    <p><button class=\"add_task\" name=\"button\">task</button></p>\n</div>\n"
	  ...
	  return "<div data-id=\""
	    ...
	    + "\">\n    <p>task: "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + " </p>\n    <p><button class=\"delete_task\" name=\"button\">delete</button></p>\n    <p><button class=\"update_task\" name=\"button\">update</button></p>\n  </div>\n";
	  ...
	  return "    <a data-id=\""
	    ...
	    + "\" class='list"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " mdl-cell mdl-cell--1-col mdl-navigation__link toggle\n    animated flipInY'><p>\n      "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\n      <i class=\"material-icons delete\" name=\"button\">delete</i>\n      <i class=\"material-icons update\" name=\"button\">mode_edit</i>\n      <i class=\"material-icons add_task\" name=\"button\">note_add</i>\n    </p>\n  </a>\n\n<ul class=\"inner\">\n"
	  ...
	  return "      <li class=\"li-table\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" data-name=\""
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\"><p>"
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + "\n        <i class=\"material-icons delete_task\" data-id=\""
	  ...
	  return "\n<li data-id=\""
	    ...
	    + "\" class='list"
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + " list-unstyled'>\n<div>\n  <table class=\"mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp testing\">\n    <thead>\n      <tr>\n        <th class=\"mdl-data-table__cell--non-numeric\">Task</th>\n        <th></th>\n        <th></th>\n        <th></th>\n        <th><button><i class=\"material-icons\">library_add</i></th>\n      </tr>\n    </thead>\n<tbody>\n  <tr>\n    <td class=\"mdl-data-table__cell--non-numeric\"><p> "
	    + alias2(alias1((depth0 != null ? depth0.name : depth0), depth0))
	    + " </p></td>\n    <!-- <td><i class=\"material-icons add_task\" name:\"button\">note_add</i></td> -->\n    <!-- <td><i class=\"material-icons update\" name:\"button\">mode_edit</i></td>\n    <td><i class=\"material-icons update\" name:\"button\">mode_edit</i></td>\n    <td><i class=\"material-icons delete\" name:\"button\">delete</i></td>\n  </tr>\n</tbody>\n</table>\n</div>\n<hr>\n</li>\n";
	  ...
	  return "<!-- <ul>\n"
	    ...
	    + "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<!-- <ul>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.list : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n</ul> -->\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createTask = function createTask(id, name) {
	  return $.ajax({
	...
	// *** UPDATE TASK ****
	var updateTask = function updateTask(listId, id, name) {
	  return $.ajax({
	...
	// *** UPDATE LIST ****
	var updateList = function updateList(id, name) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "c93e8e02f0f73c69d5905c14d0e55133.jpg";
